...
class Auth extends BaseConfig
{
    ...
    // public $hashMemoryCost = 0;  //PASSWORD_ARGON2_DEFAULT_MEMORY_COST;

    public $hashTimeCost = 4;   //PASSWORD_ARGON2_DEFAULT_TIME_COST;
    // public $hashTimeCost = 0;   //PASSWORD_ARGON2_DEFAULT_TIME_COST;

    public $hashThreads = 4;   //PASSWORD_ARGON2_DEFAULT_THREADS;
    // public $hashThreads = 0;   //PASSWORD_ARGON2_DEFAULT_THREADS;
