...
class DataPersonnelSeeder extends Seeder
{
    public function run()
    {
        // $data = [
        ...
        for ($i = 0; $i < 700; $i++) {
            $data =
                [
                    ...
                    'nik_ta'    => $faker->randomNumber(),
                    'tekprov'    => $faker->jobTitle,
                    'sto'    => $faker->streetName,
                    'witel'    => $faker->city,
                    'loker'    => $faker->streetName,
                    'mitra'    => $faker->company,
            ...
            $this->db->table('datapersonnel')->insert($data);
        }
