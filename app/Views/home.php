...
<div class="container">
    <div class="row justify-content-md-center">
        ...
        <div class="col col-lg-2 posisitengah">
            <a href="/findpersonnel" class="btn btn-outline-secondary css0">
                ...
                <strong>Appreciation & Blacklist</strong>
            </a>
        </div>


        <div class="col-md-auto posisitengah">

            <a href="/" class="btn btn-outline-secondary css0">
                ...
                <br>
                <strong>Performance of Technician (POT)</strong>
            </a>
        </div>
        ...
        <div class="col col-lg-2 posisitengah">
            <a href="/" class="btn btn-outline-secondary css0">
                ...
                <br>
                <strong>Voice of Technician (VOT)</strong>
            </a>
        </div>
    </div>
</div>
